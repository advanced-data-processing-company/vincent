...
#define ADPC_LOG_NAME(lvl)                                                     \
  ...
  void lvl(size_t module, const char *file, int line, const char *func,        \
...
#undef ADPC_LOG_NAME
   ...
   */
  void SetLevel(const size_t &id, const LogLevel level = LogLevel::ktrace,
                const LogSinkType type = LogSinkType::kterminal) {
